...
from solvebarrierNLSE import Solve_barrierNLSE
from commonfunc import SuperGauss, Soliton, Two_Pulse, Sim, Fibra, Pot, fftshift, FT, IFT
from commonfunc import find_shift, find_chirp, Adapt_Vector, saver, loader, ReSim, Adapt_Vector_1D, Adapt_Vector2
from commonfunc import find_k
...
plotinst(sim_r, fibra_r, A_tr, A_wr,dB=True , wavelength=True, zeros=False, end=-1)
...
def betaw_f(sim:Sim, fib:Fibra, deltab1, wavelength=False):
    ...
    if wavelength:
        lam, beta = Adapt_Vector_1D(sim.freq, fib.omega0, beta)
        lam, beta1 = Adapt_Vector_1D(sim.freq, fib.omega0, beta1)
        lam, beta2 = Adapt_Vector_1D(sim.freq, fib.omega0, beta2)
